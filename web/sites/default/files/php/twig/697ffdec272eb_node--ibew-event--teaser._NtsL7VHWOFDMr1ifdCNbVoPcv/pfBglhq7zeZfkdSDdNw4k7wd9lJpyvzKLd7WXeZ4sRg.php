...
<article";
  ...
  ";
    ...
    <div>
        <h3 class=\"font-oswald text-xl fw-bold text-white mb-2 group-hover:text-ibew-gold transition-colors\">
          <a href=\"";
        // line 20
        ...
        <div class=\"flex flex-wrap gap-x-6 gap-y-2 text-sm text-gray-300 mb-3\">
        ...
        <div class=\"text-sm text-gray-300 line-clamp-2 mb-4\">
             ";
        // line 39
    ...
    <div class=\"flex justify-between items-center border-top pt-3 mt-auto\">
        ...
        // line 44
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp = ($context["is_training"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("text-ibew-raspberry") : ("text-ibew-gold")));
        yield "\">
            ";
        // line 45
        ...
        // line 47
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["url"] ?? null), "html", null, true);
        yield "\" class=\"text-sm fw-bold text-ibew-gold hover:text-white text-decoration-none group-hover:translate-x-1 transition-transform inline-block\">Register &rarr;</a>
    </div>
