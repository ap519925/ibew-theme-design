...
<div class=\"ibew-page bg-gray-100 text-gray-900 min-h-screen\">
  ...
  <div class=\"ibew-header-wrapper\">
    ...
    ";
      ...
      <div class=\"ibew-shell ibew-nav__inner\">
        ...
        <!-- Mobile Menu Toggle -->
        <button class=\"ibew-mobile-toggle d-xl-none border-0 bg-transparent p-2 text-dark\" aria-label=\"Toggle Menu\" id=\"ibewMobileToggle\">
  ...
  <section class=\"ibew-hero p-0 relative h-screen\">
    ";
      ...
      ";
        // line 106
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_hero", [], "any", false, false, true, 106)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 107
            yield "        ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_hero", [], "any", false, false, true, 107), "html", null, true);
            yield "
      ";
        } else {
            // line 109
    ...
    ";
        // line 131
        yield "    ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_hero_content", [], "any", false, false, true, 131)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 132
            yield "      <div class=\"ibew-hero__content absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4 pointer-events-none\" style=\"background: transparent !important;\">
        <div class=\"pointer-events-auto max-w-4xl mx-auto w-full\" style=\"background: transparent !important;\"> 
            ";
            // line 134
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_hero_content", [], "any", false, false, true, 134), "html", null, true);
            yield "
        </div>
      </div>
    ";
  ...
  <main>
    ";
        // line 142
        yield "    ";
        $context["has_canvas"] = (CoreExtension::getAttribute($this->env, $this->source, ($context["node"] ?? null), "field_content_canvas", [], "any", false, false, true, 142) &&  !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["node"] ?? null), "field_content_canvas", [], "any", false, false, true, 142), "isEmpty", [], "method", false, false, true, 142));
        // line 143
        yield "
      ";
        // line 145
      ...
      ";
        ...
        // line 148
        yield "      ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_about", [], "any", false, false, true, 148)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 149
          ...
          <div class=\"ibew-region ibew-region--about w-100\">
            ";
            // line 151
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_about", [], "any", false, false, true, 151), "html", null, true);
            yield "
          </div>
        </section>
      ";
      ...
      ";
        // line 222
        yield "      ";
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_stats", [], "any", false, false, true, 222) || CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_members", [], "any", false, false, true, 222))) {
            // line 223
           ...
           ";
            ...
            yield "            <div class=\"ibew-region ibew-region--stats w-100\">
               ";
            // line 226
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "homepage_stats", [], "any", false, false, true, 226), "html", null, true);
            yield "
               ";
            // line 228
            yield "            </div>
    ...
    <div class=\"ibew-shell max-w-7xl mx-auto px-6\">
      ...
      <div class=\"ibew-footer__container\">
        ...
        <div class=\"ibew-footer__brand-col\">
          ";
        // line 286
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_1", [], "any", false, false, true, 286)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 287
            yield "            ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_1", [], "any", false, false, true, 287), "html", null, true);
            yield "
          ";
        } else {
            // line 289
        ...
        <div>
          ";
        // line 299
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_2", [], "any", false, false, true, 299)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 300
            yield "            ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_2", [], "any", false, false, true, 300), "html", null, true);
            yield "
          ";
        } else {
            // line 302
        ...
        <div>
          ";
        // line 314
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_3", [], "any", false, false, true, 314)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 315
            yield "            ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_3", [], "any", false, false, true, 315), "html", null, true);
            yield "
          ";
        } else {
            // line 317
        ...
        <div>
          ";
        // line 329
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_4", [], "any", false, false, true, 329)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 330
            yield "            ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer_col_4", [], "any", false, false, true, 330), "html", null, true);
            yield "
          ";
        } else {
            // line 332
      ...
      <div class=\"ibew-footer__bottom\">
        ";
        // line 351
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "footer", [], "any", false, false, true, 351)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 352
            yield "          ";
...
";
    ...
    {
        return array (  566 => 356,  560 => 354,  554 => 352,  552 => 351,  545 => 346,  529 => 332,  523 => 330,  521 => 329,  515 => 325,  505 => 317,  499 => 315,  497 => 314,  491 => 310,  481 => 302,  475 => 300,  473 => 299,  467 => 295,  459 => 289,  453 => 287,  451 => 286,  443 => 280,  408 => 246,  405 => 244,  403 => 235,  400 => 233,  395 => 230,  392 => 228,  388 => 226,  385 => 225,  382 => 223,  379 => 222,  376 => 220,  351 => 212,  323 => 186,  315 => 179,  294 => 174,  285 => 167,  281 => 164,  279 => 163,  277 => 162,  274 => 160,  271 => 158,  268 => 157,  265 => 155,  258 => 151,  254 => 149,  251 => 148,  249 => 147,  246 => 145,  243 => 143,  240 => 142,  235 => 138,  228 => 134,  224 => 132,  221 => 131,  217 => 128,  213 => 125,  196 => 110,  194 => 109,  188 => 107,  186 => 106,  183 => 105,  168 => 91,  145 => 70,  137 => 64,  131 => 61,  127 => 60,  123 => 59,  119 => 58,  115 => 57,  111 => 56,  108 => 55,  102 => 53,  100 => 52,  97 => 51,  90 => 46,  86 => 45,  79 => 40,  51 => 13,  44 => 7,);
    }
    ...
    {
        static $tags = ["if" => 52, "set" => 142];
        static $filters = ["t" => 45, "escape" => 53, "date" => 354];
        static $functions = [];
